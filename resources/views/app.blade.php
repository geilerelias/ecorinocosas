...
<head>
    ...
    <!-- Favicon principal -->
    <link rel="icon" href="{{ asset('resources/images/logo/favicon.ico') }}">
    <link rel="icon" href="/favicon.ico" sizes="any">

    <!-- ✅ Iconos PWA / Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('resources/images/logo/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('resources/images/logo/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('resources/images/logo/favicon-16x16.png') }}">
    ...
    <meta property="og:image" content="{{ asset('resources/images/logo/android-chrome-512x512.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('resources/images/logo/android-chrome-512x512.png') }}">
