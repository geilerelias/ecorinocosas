import{X as o}from"./app-CGsLUfSn.js";const s=o("blog",{state:()=>({articles:[],loading:!1}),getters:{categories:e=>{const a=e.articles.map(i=>i.category);return Array.from(new Set(a))},randomArticles:e=>[...e.articles].sort(()=>.5-Math.random()).slice(0,3)},actions:{async fetchArticles(){if(!this.articles.length){this.loading=!0;try{this.articles=[{id:1,title:"Colombia lidera la transición energética en América Latina con proyectos solares",slug:"colombia-lidera-transicion-energetica",excerpt:"El país alcanza 3.5 GW de capacidad solar instalada, posicionándose como referente regional en energías renovables y atrayendo inversión extranjera.",content:`
